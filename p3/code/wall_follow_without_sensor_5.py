...
class WallFollow:
    ...
    def init_fuzzy(self):
        ...
        # Turn left
        rule_l1 = ctrl.Rule(distances_front_sensors[0]['close'] | distances_front_sensors[1]['close'], v_left['zero'])
        rule_r1 = ctrl.Rule(distances_front_sensors[0]['close'] | distances_front_sensors[1]['close'], v_right['fast'])
