...
class WallFollow:
    ...
    def init_fuzzy(self):
        ...
        for i in range(3):
            ...
            distances_front_sensors[i]['close'] = fuzz.zmf(distances_front_sensors[i].universe, 0.3, 0.8)
            distances_front_sensors[i]['away'] = fuzz.smf(distances_front_sensors[i].universe, 0.3, 0.8)
