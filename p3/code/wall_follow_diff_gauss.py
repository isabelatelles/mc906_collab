...
class WallFollow:
    ...
    def init_fuzzy(self):
        ...
        difference_right_sensors['negative'] = fuzz.gaussmf(difference_right_sensors.universe, -1, 0.25)
        difference_right_sensors['zero'] = fuzz.gaussmf(difference_right_sensors.universe, 0, 0.015)
        difference_right_sensors['positive'] = fuzz.gaussmf(difference_right_sensors.universe, 1, 0.25)
